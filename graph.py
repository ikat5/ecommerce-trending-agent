...
def build_graph():
    ...
    workflow.add_node("keyword_db", postgres_search_node)
    ...
    workflow.add_edge("parse", "vector_db")
    workflow.add_edge("vector_db", "keyword_db")
    workflow.add_edge("keyword_db", "rank")
